...
const AddHouse = () => {
   ...
   const handleAddHouse = async () => {
      ...
      try {
         ...
         const { data } = await axiosPublic.post("/api/house", houseData, config);
         console.log(data)
         ...
         <div className="max-w-screen-md mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5 border border-gray-400 rounded-md p-3">
               ...
               <div>
                  ...
                  <input onChange={(e) => setNumber(e.target.value)} type="number" name="" id="" placeholder="Phone Number" className="w-full p-3 border rounded-md border-gray-400 outline-none" />
               </div>
               <div>
               ...
               <div className="col-span-2 bg-yellow-200 hover:bg-yellow-400">
                  <button onClick={handleAddHouse} type="text" name="" id="" placeholder="Description" className="w-full p-2 font-semibold border rounded-md border-gray-400 outline-none text-2xl" >Submit</button>
               </div>
            </div>
         </div>
      </>
